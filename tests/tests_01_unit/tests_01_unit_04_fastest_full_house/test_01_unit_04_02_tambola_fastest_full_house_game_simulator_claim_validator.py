from src.tambola_game_simulator.tambola_fastest_full_house_game_simulator import TambolaFastestFullHouseGameSimulator
...
def test_init_tambola_fastest_full_house_game_simulator_game_type_lt_lower_limit_is_not_permitted():
    game_type = 0
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
    ...
    with pytest.raises(ValueError):
        ...
        tambola_game_simulator = TambolaFastestFullHouseGameSimulator(game_type, call_seq_len_gen, call_seq_gen, player_gen, ticket_gen, claim_validator, caller, player_index_list, game_simulator_file_logger)

def test_init_tambola_fastest_full_house_game_simulator_game_type_gt_upper_limit_is_not_permitted():
    game_type = 6    
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_calling_sequence_generator_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_calling_sequence_len_generator_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_ticket_generator_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_player_generator_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_claim_validator_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_caller_not_none():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_player_index_list_not_empty():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_init_tambola_fastest_full_house_game_simulator_player_index_list_of_expected_len():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_inaccurate_claim_is_rejected_one():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    ...
    ticket_gen = FastestFullHouseTicketGenerator(call_seq, num_players, game_type, claim_player_index, claiming_player_type, claiming_player_sub_type)
    tambola_game_simulator = TambolaFastestFullHouseGameSimulator(game_type, call_seq_len_gen, call_seq_gen, player_gen, ticket_gen, claim_validator, caller, player_index_list, game_simulator_file_logger)
    validation_result = tambola_game_simulator.validate_fastest_full_house_technically_inaccurate_claim()

    assert not validation_result

def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_inaccurate_claim_is_rejected_two():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_INACCURATE"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_inaccurate_claim_is_rejected_three():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_INACCURATE"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_but_invalid_claim_is_rejected_one():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    ...
    ticket_gen = FastestFullHouseTicketGenerator(call_seq, num_players, game_type, claim_player_index, claiming_player_type, claiming_player_sub_type)
    tambola_game_simulator = TambolaFastestFullHouseGameSimulator(game_type, call_seq_len_gen, call_seq_gen, player_gen, ticket_gen, claim_validator, caller, player_index_list, game_simulator_file_logger)
    validation_result = tambola_game_simulator.validate_fastest_full_house_technically_accurate_but_invalid_claim()

    assert not validation_result

def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_but_invalid_claim_is_rejected_two():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_BUT_INVALID"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_but_invalid_claim_is_rejected_three():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_BUT_INVALID"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_and_valid_claim_is_accepted_one():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
    claiming_player_sub_type = possible_claiming_player_technically_accurate_and_valid_sub_types["TECHNICALLY_ACCURATE_AND_VALID_TYPE_1"]
    ...
    ticket_gen = FastestFullHouseTicketGenerator(call_seq, num_players, game_type, claim_player_index, claiming_player_type, claiming_player_sub_type)
    tambola_game_simulator = TambolaFastestFullHouseGameSimulator(game_type, call_seq_len_gen, call_seq_gen, player_gen, ticket_gen, claim_validator, caller, player_index_list, game_simulator_file_logger)
    validation_result = tambola_game_simulator.validate_fastest_full_house_technically_accurate_and_valid_claim()

    assert validation_result

def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_and_valid_claim_is_accepted_two():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_tambola_fastest_full_house_game_simulator_fastest_third_row_technically_accurate_and_valid_claim_is_accepted_three():
    game_type = round_game_type["FASTEST_FULL_HOUSE"]
    claim_player_index = game_claim_player_index["FASTEST_FULL_HOUSE"]
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
