from src.tambola_game_simulator.tambola_fastest_third_row_game_simulator import TambolaFastestThirdRowGameSimulator
...
def test_init_tambola_fastest_third_row_game_simulator_game_type_lt_lower_limit_is_not_permitted():
    game_type = 0
    ...
    with pytest.raises(ValueError):
        ...
        tambola_game_simulator = TambolaFastestThirdRowGameSimulator(game_type, call_seq_len_gen, call_seq_gen, player_gen, ticket_gen, claim_validator, caller, player_index_list, game_simulator_file_logger)

def test_init_tambola_fastest_third_row_game_simulator_game_type_gt_upper_limit_is_not_permitted():
    game_type = 6
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_calling_sequence_generator_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_calling_sequence_len_generator_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_ticket_generator_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_player_generator_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_claim_validator_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_caller_not_none():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_player_index_list_not_empty():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_init_tambola_fastest_third_row_game_simulator_player_index_list_of_expected_len():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
...
def test_tambola_game_fastest_third_row_simulator_fastest_third_row_technically_inaccurate_claim_is_rejected():
...
def test_tambola_fastest_third_row_game_simulator_fastest_third_row_technically_accurate_but_invalid_claim_is_rejected():
...
def test_tambola_fastest_third_row_game_simulator_fastest_third_row_technically_accurate_and_valid_claim_is_accepted():
    claiming_player_type = possible_claiming_player_types["TECHNICALLY_ACCURATE_AND_VALID"]
