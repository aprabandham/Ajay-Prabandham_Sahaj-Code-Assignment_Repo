...
class TambolaFastestFullHouseGameSimulator(TambolaGameSimulatorInterface):
    ...
    def validate_fastest_full_house_technically_inaccurate_claim(self):
    ...
    def validate_fastest_full_house_technically_accurate_but_invalid_claim(self):
    ...
    def validate_fastest_full_house_technically_accurate_and_valid_claim(self):
