...
class FastestSecondRowTicketGenerator(TicketGeneratorInterface):
    def __init__(self, call_seq, num_players, game_type, claim_player_index, claiming_player_type):
        ...
        if game_type != round_game_type["FASTEST_SECOND_ROW"]:
            raise ValueError("The value provided for Game Type is not permitted!")

        if claim_player_index != game_claim_player_index["FASTEST_SECOND_ROW"]:
    ...
    def _generate_ticket_with_technically_inaccurate_claim(self, player_index):
        ticket_arr = []
        ticket_arr_second_row = self._generate_fastest_second_row_arr_for_ticket_technically_inaccurate_claim()
        ticket_arr_first_row = self._generate_fastest_second_row_claim_first_row_arr(ticket_arr_second_row)
        ticket_arr_third_row = self._generate_fastest_second_row_claim_third_row_arr(ticket_arr_second_row, ticket_arr_first_row)
    ...
    def _generate_ticket_with_technically_accurate_but_invalid_claim(self, player_index):
        ticket_arr = []
        ticket_arr_second_row = self._generate_fastest_second_row_arr_for_ticket_technically_accurate_but_invalid_claim()
        ticket_arr_first_row = self._generate_fastest_second_row_claim_first_row_arr(ticket_arr_second_row)
        ticket_arr_third_row = self._generate_fastest_second_row_claim_third_row_arr(ticket_arr_second_row, ticket_arr_first_row)
    ...
    def _generate_ticket_with_technically_accurate_and_valid_claim(self, player_index):
        ticket_arr = []
        ticket_arr_second_row = self._generate_fastest_second_row_arr_for_ticket_technically_accurate_and_valid_claim()
        ticket_arr_first_row = self._generate_fastest_second_row_claim_first_row_arr(ticket_arr_second_row)
        ticket_arr_third_row = self._generate_fastest_second_row_claim_third_row_arr(ticket_arr_second_row, ticket_arr_first_row)
    ...
    def _generate_fastest_second_row_arr_for_ticket_technically_inaccurate_claim(self):
        ticket_arr_second_row = []    
        ticket_arr_second_row_nums = []
        
        second_row_accurate_pop = self.call_seq
        ...
        second_row_inaccurate_pop = list(set(calling_seq_range) - set(self.call_seq))
    ...
    def _generate_fastest_second_row_arr_for_ticket_technically_accurate_but_invalid_claim(self):
            ...
            second_row_pop = self.call_seq[0:call_seq_len-2]
    ...
    def _generate_fastest_second_row_arr_for_ticket_technically_accurate_and_valid_claim(self):
            call_seq_len = len(self.call_seq)
            
            ticket_arr_second_row = []
            ticket_arr_second_row_nums = []
            seq_last_num = self.call_seq[LIST_LAST_INDEX]
            second_row_pop = self.call_seq[0:call_seq_len-1]
            second_row_prefix = random_sample(second_row_pop, ROW_LEN-1)
            ticket_arr_second_row_nums.extend(second_row_prefix)
    ...
    def _generate_fastest_second_row_claim_first_row_arr(self, ticket_arr_second_row):
    ...
    def _generate_fastest_second_row_claim_third_row_arr(self, ticket_arr_second_row, ticket_arr_first_row):
